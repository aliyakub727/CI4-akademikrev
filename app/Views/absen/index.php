        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col">       
                        <a class="btn btn-primary mb-4" href="<?= base_url(); ?>/NilaiController/absentambah">Tambah  Absen</a>                        
                            ...
                            <tbody>
                                ...
                                <?php foreach ($absen as $k) : ?>
                                    <tr>
                                        ...
                                        <td><?= $k['nama_kelas']; ?></td>
                                        <td>
                                            <a href="<?= base_url("/NilaiController/absenedit/".$k['id_absen'])?>" class="btn btn-primary">Input Absen</a>
                                            <a href="<?= base_url("/NilaiController/deleteabsen/".$k['id_absen'])?>" class="btn btn-primary">Delete Absen</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
