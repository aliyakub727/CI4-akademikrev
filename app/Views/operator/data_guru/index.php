                        ...
                        <div class="col">
                            <div class="row">
                                ...
                                <div class="col" style="text-align:end">
                                    <button type=" button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#import">Import</button>
                                    <a href="<?= base_url() ?>/operator/exportguruxlxs" class="btn btn-primary mb-4">Export</a>
                                </div>
                            </div>
